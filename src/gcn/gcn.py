...
import json
from main_subgraph import make_graph
from main import to_networkx
from preprocess import generate_data, generate_graph
...
# file_path = '/ds1/data_f/facebook_combined.txt.gz'
# G = load_graph(file_path)
# data = create_pyg_data(G)
# node = 0
# data = make_graph(node)
# G = to_networkx(data)
